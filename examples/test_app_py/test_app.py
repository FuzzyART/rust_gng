import sys,os
notebook_dir = os.path.dirname(os.path.abspath("__file__"))  # Might not work in Jupyter
## Instead, in Jupyter, use:
#notebook_dir = os.getcwd()
a_lib_path = os.path.join(notebook_dir, '../gng_py/target/release')
sys.path.insert(0, os.path.abspath(a_lib_path))
